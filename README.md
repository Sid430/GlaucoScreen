...
This project is for research and educational purposes only and is not intended for clinical diagnosis or treatment.
...
🧠 Models Used
Task	Model Type	Input
Glaucoma Detection	CNN (Keras .h5)	Fundus image
Progression Detection	CNN (Keras .h5)	Fundus image
Risk Adjustment	Logistic Regression (.pkl)	Age, Gender
...
📈 Performance Summary
Task	Metric	Score
Segmentation	IOU	95.11%
Detection	Accuracy	98.68%
Detection	AUC	0.99
Progression	Accuracy	95.88%
Progression	AUC	0.99
🌍 Impact
